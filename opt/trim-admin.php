...
add_action('admin_head', 'acf_edit');
...
function custom_login() {
  echo '<style>
  body{background-image:url('.TEMPLATE_URI.'/assets/img/thm/bg.png)}
  #loginform{box-shadow:0 0 260px #fff;background-image:url('.TEMPLATE_URI.'/assets/img/thm/gradient.png)}
...
function acf_edit() {
  echo '<style>
  .acf-fields.-sidebar:before {width: 199px;}
  .acf-fields.-sidebar {padding-left: 200px !important;}
  .acf-tab-wrap.-left .acf-tab-group {width: 200px;}
  </style>';
}
